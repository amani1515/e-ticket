        ...
        <nav x-data="{ openTickets: false, openReports: false }" class="space-y-2">
            ...
            <div class="group">
                ...
                <div x-show="openReports" x-collapse class="ml-8 mt-2 space-y-1">
                    ...
                    <a href="{{ route('ticketer.cash-report.list') }}" class="flex items-center px-4 py-2 text-sm rounded-lg hover:bg-blue-700 hover:text-yellow-300 transition-colors duration-200">
                        <svg class="w-4 h-4 mr-2 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
