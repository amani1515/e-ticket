                                ...
                                <tr class="hover:bg-amber-50 transition-colors duration-200">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex flex-wrap gap-1">
                                            ...
                                            <a href="{{ route('admin.tickets.receipt', $ticket->id) }}" target="_blank" class="inline-flex items-center px-2 py-1 text-xs font-medium text-green-800 bg-green-100 rounded-lg hover:bg-green-200 transition-colors duration-200">
                                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
