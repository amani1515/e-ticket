<div x-data="{ openSidebar: false }" class="relative md:static h-screen">
    ...
    <div :class="openSidebar ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex-1 px-4 py-6 overflow-y-auto">
            <nav x-data="{ openUser: false, openDestination: false, openMahberat: false, openReports: false }" class="space-y-2">
...
@if (Auth::user()->usertype === 'headoffice')
                    <!-- Direct Report Links for HeadOffice -->
                    <div class="group">
                ...
                @else
                    <!-- Reports Submenu for Other Users -->
                    <div class="group">
