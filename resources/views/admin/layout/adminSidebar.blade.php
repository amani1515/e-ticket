<div x-data="{ openSidebar: false }" class="relative md:static h-screen">
    ...
    >
        ...
        <div x-data="{ openUser: false, openDestination: false, openReports: false }" class="space-y-4">
            <!-- User -->
            <div>
                <button @click="openUser = !openUser" class="flex justify-between items-center w-full font-semibold hover:text-yellow-500">
                    User
            ...
            <div>
                ...
                <div x-show="openDestination" x-cloak class="ml-4 mt-2 space-y-1 text-sm">
                    <a href="{{ route('admin.destinations.index') }}" class="block hover:text-yellow-500">Destinations</a>
            ...
            <!-- Reports -->
            <div>
                <button @click="openReports = !openReports" class="flex justify-between items-center w-full font-semibold hover:text-yellow-500">
                    Reports
                ...
                <div x-show="openReports" x-cloak class="ml-4 mt-2 space-y-1 text-sm">
                    <a href="{{ route('admin.passenger-report') }}" class="block hover:text-yellow-500">Passenger Report</a>
