...
<div class="max-w-5xl mx-auto bg-white p-6 rounded shadow mt-10">
    ...
    <div id="add-template-modal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
            ...
            @foreach($templates as $template)
                <tr>
                    ...
                    <td class="border px-4 py-2 text-center">
                        <form action="{{ route('admin.sms-template.destroy', $template->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this template?');">
                            @csrf
                            @method('DELETE')
